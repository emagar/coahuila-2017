...
\\[-1.8ex] & \multicolumn{1}{c}{(1)} & \multicolumn{1}{c}{(2)} & \multicolumn{1}{c}{(3)} & \multicolumn{1}{c}{(4)} & \multicolumn{1}{c}{(5)} & \multicolumn{1}{c}{(6)} & \multicolumn{1}{c}{(7)} & \multicolumn{1}{c}{(8)} & \multicolumn{1}{c}{(9)}\\ 
  & \multicolumn{1}{c}{Javier} & \multicolumn{1}{c}{Lily} & \multicolumn{1}{c}{Gina} & \multicolumn{1}{c}{A.Isabel} & \multicolumn{1}{c}{Sonia} & \multicolumn{1}{c}{Lencho} & \multicolumn{1}{c}{Lariza} & \multicolumn{1}{c}{Armando} & \multicolumn{1}{c}{Leonel}\\ 
\hline \\[-1.8ex] 
...
Log Likelihood & \multicolumn{1}{c}{-262.32} & \multicolumn{1}{c}{-231.34} & \multicolumn{1}{c}{-169.84} & \multicolumn{1}{c}{-175.64} & \multicolumn{1}{c}{-235.20} & \multicolumn{1}{c}{-205.60} & \multicolumn{1}{c}{-229.85} & \multicolumn{1}{c}{-147.10} & \multicolumn{1}{c}{-182.89} \\ 
\hline 
\hline \\[-1.8ex] 
...
% Table created by stargazer v.5.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Thu, Feb 15, 2018 - 04:20:23 PM
...
\hline \\[-1.8ex] 
 ...
 constante & -3.03^{***} & -3.82^{***} & -4.45^{***} & -3.99^{***} & -3.49^{***} & -3.48^{***} & -3.29^{***} & -3.87^{***} \\ 
  ...
  & & & & & & & & \\ 
\hline \\[-1.8ex] 
Observations & \multicolumn{1}{c}{1,008} & \multicolumn{1}{c}{1,008} & \multicolumn{1}{c}{1,008} & \multicolumn{1}{c}{1,008} & \multicolumn{1}{c}{1,008} & \multicolumn{1}{c}{1,008} & \multicolumn{1}{c}{1,008} & \multicolumn{1}{c}{1,008} \\ 
Log Likelihood & \multicolumn{1}{c}{-262.32} & \multicolumn{1}{c}{-231.34} & \multicolumn{1}{c}{-169.84} & \multicolumn{1}{c}{-175.64} & \multicolumn{1}{c}{-235.20} & \multicolumn{1}{c}{-205.60} & \multicolumn{1}{c}{-229.85} & \multicolumn{1}{c}{-147.10} \\ 
\hline 
\hline \\[-1.8ex] 
